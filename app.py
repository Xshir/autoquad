...
def get_lidar_data():
    try:
        ...
        return jsonify({"distance": distance, "temperature": temperature, "signal_strength": signal_strength, "battery_voltage": vehicle.vehicle.battery.voltage, "battery_level": vehicle.vehicle.battery.level})
    except Exception as e:
